/* Shared constants for the public legal documents. Update here if the
 * legal entity, contact details, or document dates change. */
export const APP_NAME = 'InboundSelect';
export const LEGAL_ENTITY = 'INBOUND SELECT LLC';
